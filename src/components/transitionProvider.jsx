...
const TransitionProvider = ({ children }) => {
  ...
  return (
    <AnimatePresence mode="wait">
      ...
      >
        {/* Top Overlay - Added pointer-events-none */}
        <motion.div
        ...
        {/* Path Text Overlay - Added pointer-events-none */}
        <motion.div
          className="fixed m-auto top-0 left-0 right-0 bottom-0 text-white text-8xl cursor-default z-50 w-fit h-fit pointer-events-none"
          initial={{ opacity: 1 }}
          animate={{ opacity: 0 }}
          exit={{ opacity: 0 }}
        ...
        {/* Bottom Overlay - Added pointer-events-none */}
        <motion.div
